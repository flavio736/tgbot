...
def __chat_settings__(chat_id, user_id):
    return "Tu es *admin*: `{}`".format(
        dispatcher.bot.get_chat_member(chat_id, user_id).status in ("administrator", "creator"))


__help__ = """
 - /adminlist: lista de administradores no chat

*Admin only:*
 - /pin: silenciosamente fixa a mensagem respondida para - adicionar 'alto' ou 'notificar' para dar notifs aos usuários.
 - /unpin: desativa a mensagem atualmente fixada
 - /invitelink: recebe link de convite
 - /promote: promove o usuário respondeu
 - /demote: rebaixa o usuário respondeu
"""
